...
function Modal() {
  ...
  return (
        <div>
            ...
            { modal2 && <div className={modalStyle.modal}>
            <div className={modalStyle.overlay}> </div>
                <div className={modalStyle.modal_content}>
                        ...
                        <p className={modalStyle.modalText}> Your order has been accepted by </p>
                        <h5 className={modalStyle.modalTitle}>Babatunde Akin</h5>


                <div className={modalStyle.modalArrange}>
                <button className={modalStyle.modalBtn1} onClick={toggleModal}>View Rider</button>
        ...
        { modal && <div className={modalStyle.modal}>
            <div className={modalStyle.overlay}> </div>
                <div className={modalStyle.modal_content2}>
                        <h5 className={modalStyle.modalName}>Rider arriving in 8mins </h5>
                        <img className={modalStyle.requestProfilePic} src={profilePic} alt="profilePic"  />
                        <h5 className={modalStyle.modalTitle}>Babatunde Akin</h5>
                        ...
                        <p className={modalStyle.modalNo}> 4.82 <AiFillStar /></p>
