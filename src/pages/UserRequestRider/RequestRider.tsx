                    ...
                    <div className={requestRider.requestFirstLeft}>
                        <form className={requestRider.userOrder_f} onSubmit={handleSubmit}>
                            ...
                            <input
                                ...
                                name="offerAmount"
                            />
                            <label className={requestRider.requestLabel}>Payment Method</label>
                            <div className={requestRider.requestLabel} style={{display:"flex"}}>
                                <div style={{display:"flex", width: "50%"}}>
                                    <label style={{display: "block",width: "50%", margin: "auto 0px"}} htmlFor="cash" className={requestRider.requestLabel}>Cash</label>
                                    <input
                                        style={{width:"10%", margin: "auto 0",cursor:"pointer"}}
                                        className={requestRider.requestInput}
                                        onChange={handleChange}
                                        type="radio"
                                        value="Cash"
                                ...
                                <div style={{display:"flex", width: "50%"}}>
                                    <label  style={{display: "block",width: "50%", margin: "auto 0px"}} htmlFor="card" className={requestRider.requestLabel}>Card</label>
                                    <input
                                        style={{width:"10%", margin: "auto 0",cursor:"pointer"}}
                                        className={requestRider.requestInput}
                                        onChange={handleChange}
