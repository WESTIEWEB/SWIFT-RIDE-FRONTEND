...
import Navbar from "../../components/Navbar/NavbarBidingOrder";
import riderOrderStyle from "./RiderBidingOrder.module.css";
...
const BidingOrder = () => {
	...
	const getOrders = async () => {
		setLoading(true);
		const response = await apiGet("/all-biddings");
							...
							{orders.map((order: any) => (
								...
								>
									...
									<div className={riderOrderStyle.biding_order_button_div}>
										<Link className={riderOrderStyle.diding_order_link} to="/">
